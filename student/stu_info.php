	   ...
	   <br>
				...
				if(isset($_GET['suk'])){
						...
						$sql1="SELECT * FROM batch_master INNER JOIN student_master ON batch_master.batch_mas_key=student_master.batch_key 
										  ...
										  WHERE student_master.student_key='$ukey'";
				...
				?>
									...
									<div class="panel-body panel-transparent">
										<table border="0" width="100%">
											<tr style="font-size:16px;font-weight:bold">
												<td rowspan="9" width="20%"><img src="../admin/studentphotosupload/<?php echo $y7; ?>" width="100%" height="120px"></td>
												<td width="2%" ></td>
					...
					<?php
					$sql2="SELECT * FROM cur_statusofbatch_details 
															WHERE curstatusbatch_detail_key='$_GET[curyr]'
															AND status=0 
															ORDER BY curstatusbatch_detail_key DESC";
									...
									<section class="panel panel-transparent">
										<div class="panel-body panel-transparent">
											...
											$sql3="SELECT * FROM course_master INNER JOIN cur_statusofbatch_details ON course_master.course_key=cur_statusofbatch_details.coursemas_key
																			  ...
																			  WHERE cur_statusofbatch_details.curstatusbatch_detail_key='$_GET[curyr]'
											...
											?>
												...
												<table class="table table-striped table-bordered" width="100%">
													<tbody>
														<?php
														$sql4="SELECT * FROM subject_master WHERE subject_key='$_GET[suk]' AND status=0";
														...
														<tr>
															<td width="100%">
																...
																if(mysqli_num_rows($result5)>0){
																	...
																	$sql6="SELECT * FROM attendance_details WHERE student_key='$ukey' AND subject_key='$row4[subject_key]' AND  curstatusofbatch_key='$row2[curstatusbatch_detail_key]' AND status=0";
																		...
																		<tbody>
																				...
																				while($row7=mysqli_fetch_array($result7)){
																					echo "<tr>
																						...
																						$sql8="SELECT * FROM assignment_details WHERE assignmentmgt_key='$row7[assignmentmgtmas_key]' AND student_key='$ukey' AND subject_key='$row4[subject_key]' AND curstatusofbatch_key='$row2[curstatusbatch_detail_key]' AND status=0";
