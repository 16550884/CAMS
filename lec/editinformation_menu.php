				...
				<div class="col-md-10">
					<section class="panel panel-transparent">
						<div class="panel-body panel-transparent">
							<div style="font-size:16px;font-weight:bold;"align="center">Edit schedul Information </div>
						</div>
					</section>
				</div>
			</div>
						...
						<div class="panel-body panel-transparent">
							<table class="table display" id="example" width="100%">
                                        ...
                                        <tbody>
											...
											?>
													<tr class="clickable-row" data-href="edit_info.php?suk=<?php echo $row1['subject_key'];?>&curyr=<?php echo $row1['curstatusbatch_detail_key'];?>">
														...
														<td><a href="edit_info.php?suk=<?php echo $row1['subject_key'];?>&curyr=<?php echo $row1['curstatusbatch_detail_key'];?>"><button class='btn btn-sm btn-primary btn-block'>Process</button></a></td>
													</tr>
											<?php
												}
											?>
